...
<head>
    ...
    <title>402 Pembayaran Diperlukan - Si Panda</title>
...
<div class="flex flex-col items-center justify-center min-h-screen px-6 py-12">
    <div class="max-w-md text-center">
        ...
        {{-- Error Code --}}
        <p class="text-6xl font-extrabold text-sky-600 dark:text-sky-400" style="font-size: 8rem; line-height: 1;">402</p>

        {{-- Error Title --}}
        <h1 class="mt-4 text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl">Pembayaran Diperlukan.</h1>

        {{-- Error Description --}}
        <p class="mt-4 text-base text-slate-600 dark:text-slate-400">
            Akses ke konten atau halaman ini memerlukan pembayaran. Silakan selesaikan proses pembayaran untuk melanjutkan.
        </p>
